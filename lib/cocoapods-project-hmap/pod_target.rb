  ...
  class PodTarget
    ...
    def recursively_add_dependent_headers_to_hmap(hmap, generate_type)
      dependent_targets.each do |depend_target|
        ...
        hmap.add_hmap_with_header_mapping(depend_target.public_header_mappings_by_file_accessor, generate_type,
                                          depend_target.name, depend_target.product_module_name)
